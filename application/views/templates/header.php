        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbar-menu">
            <ul class="nav navbar-nav menu">
              <li><a href="<?= base_url() ?>controller_utama/dashboard">Home</a></li>
              <li><a href="<?= base_url() ?>controller_utama/contact">Contact</a></li>
              <li><a href="<?= base_url() ?>controller_utama/developer_team">Developer Team</a></li>
            </ul>
          </div>
        </div>
      </nav>
